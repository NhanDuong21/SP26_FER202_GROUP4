...
export default function PostsPage() {
  ...
  const statCards = [
    { title: "Tổng bài viết", value: total, icon: FileText, iconClass: "bg-sky-100 text-sky-600" },
    { title: "Đã xuất bản", value: published, icon: Eye, iconClass: "bg-emerald-100 text-emerald-600" },
    { title: "Bản nháp", value: drafts, icon: Pencil, iconClass: "bg-yellow-100 text-yellow-600" },
    { title: "Tổng lượt xem", value: totalViews, icon: User, iconClass: "bg-violet-100 text-violet-600" },
  ];
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-800">Quản lý Bài viết</h1>
          <p className="mt-2 text-slate-500">Quản lý nội dung blog</p>
        </div>
      ...
      <div className={cardClass}>
        <div className={sectionHeaderClass}>
          <div>
            <h2 className="text-lg font-semibold text-slate-800">Danh sách bài viết</h2>
            <p className="mt-1 text-sm text-slate-500">Quản lý nội dung blog</p>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[900px] text-sm">
              <thead className="bg-slate-50">
                <tr>
                  <th className={tableHeaderCellClass}>Ảnh đại diện</th>
                  <th className={tableHeaderCellClass}>Tiêu đề</th>
                  <th className={tableHeaderCellClass}>Tác giả</th>
                  <th className={tableHeaderCellClass}>Danh mục</th>
                  <th className={tableHeaderCellClass}>Trạng thái</th>
                  <th className={tableHeaderCellClass}>Lượt xem</th>
                  <th className={tableHeaderCellClass}>Ngày xuất bản</th>
            ...
            <div className="px-6 py-4 flex items-center justify-between text-sm text-slate-600">
              <div>{`1-${filtered.length} của ${filtered.length} bài viết`}</div>
